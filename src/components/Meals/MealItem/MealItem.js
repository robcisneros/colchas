  ...
  return (
    <React.Fragment>
      ...
      <div className="flex justify-between m-4 pb-4 border-b border-solid border-gray-400">
        <div className="w-40 h-40 flex flex-wrap self-center" onClick={showDetailsHandler}>
          <img
        ...
        <div className="flex flex-col items-end  w-1/2">
          ...
          <div className="mt-1 font-bold text-xl text-rosaFuerte text-right">
            {price}
          </div>
          <p className="mb-1 text-right"> {props.size} </p>
